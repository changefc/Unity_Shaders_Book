Shader "Unity Shaders Book/Chapter 12/Gaussian Blur Far"
{
	Properties
	{
	...
	SubShader
	{
		...
		v2f vertBlurVertical(appdata_img v){
			...
			half2 uv = v.texcoord;
			o.uv[0] = uv;
			o.uv[1] = uv + half2(0,_MainTex_TexelSize.y * 1.0)*_BlurSize;
			o.uv[2] = uv - half2(0,_MainTex_TexelSize.y * 1.0)*_BlurSize;
